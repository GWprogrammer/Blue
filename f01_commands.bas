...
ABS(<nexp>), 56
ACOS(<nexp>), 59
Adoc.delete <success_nvar>, <documentPath_sexp>, 
Adoc.exists <lvar>, <documentPath_sexp>, 
Adoc.get <documentPath_svar>{{, <startPath_sexp>}, <mimeType_sexp>}, 
Adoc.grab <result_sexp>, <documentPath_sexp>{, <charSet_sexp>}, 
Adoc.lastmodified <success_nvar>, <documentLastModified_nvar>, <documentPath_sexp>, 
Adoc.mimetype <success_nvar>, <mimeType_svar>, <documentPath_sexp>, 
Adoc.name <documentName_svar>, <documentPath_sexp>, 
Adoc.open <documentPath_svar>{{, <startPath_sexp>}, <mimeType_sexp>}, 
Adoc.path <documentPath_svar>, <filePath_sexp>, 
Adoc.read <success_nvar>, <result_sexp>, <documentPath_sexp>{, <charSet_sexp>}, 
Adoc.rename <success_nvar>, <documentPath_sexp>, <newName_sexp>, 
Adoc.revoke <success_nvar>, <documentPath_sexp>, 
Adoc.save <documentPath_svar>, <documentName_svar>{{, <startPath_sexp>}, <mimeType_sexp>}, 
Adoc.size <documentSize_nvar>, <documentPath_sexp>, 
Adoc.write <success_nvar>, <documentPath_sexp>, <newContent_sexp>{, <charSet_sexp>}, 
...
Array.from.string <sexp>, Array[], 
Array.length n, Array[{<start>,<length>}], 41
Array.length n, Array$[{<start>,<length>}], 41
Array.load Array[], <nexp>, ..., 41
Array.load Array$[], <sexp>, ..., 41
Array.mat.toggle SourceArray[], {<direction_sexp>}, DestinationArray[], 
Array.mat.toggle SourceArray$[], {<direction_sexp>}, DestinationArray$[], 
Array.mat.transpose SourceArray[], DestinationArray[], 
Array.mat.transpose SourceArray$[], DestinationArray$[], 
Array.mat.skill <Bundle_Pointer_nexp>{, <runtime_error_nexp>}, 
Array.math LeftArray[], RightArray[], <operator_sexp>, ResultArray[], 
Array.max <max_nvar> Array[{<start>,<length>}], 42
Array.min <min_nvar>, Array[{<start>,<length>}], 42
Array.reverse Array[{<start>,<length>}], 42
Array.reverse Array$[{<start>,<length>}], 42
Array.Rnd Array[] {{{{{{, <length_nexp>}, <low|offset_nexp>}, <high|scale_nexp>}, <seed_nexp>}, <type_nexp>}, <generator_nexp>}, 
Array.search Array[{<start>,<length>}], <search_nexp>, <result_nvar>{,<start_nexp>}, 
Array.search Array$[{<start>,<length>}], <search_sexp>, <result_nvar>{,<start_nexp>}, 
...
Bundle.gj <pointer_nexp>, <json_sexp>{, <spaces_nexp>}, 
...
Bundle.gv <pointer_nexp>, <key_sexp>, <boolean_nval|Array[]>, 
...
Bundle.pj <pointer_nexp>, <json_sexp>, 
...
Bundle.pv <pointer_nexp>, <key_sexp>, <boolean_nexp|Array[]>, 
...
Console.title {{ <title_sexp>}, <options_bundle_nexp>}, 
...
Device <svar>, 135
Device.brightness.auto <bright_nexp>, 
Device.brightness.get <brigth_nvar>, 
Device.brightness.set <brigth_nvar>, 
Device.language <svar>, 136
Device.locale <svar>, 137
Device.os <os_nvar>, 
...
Dir <path_sexp>, Array$[] {{{{,<dirmark_sexp>},<timeStamp_nexp>},  <recursive_nexp>}, <type_sexp>}, 
Do / Until <lexp>, 80
Echo.off, 91
Echo.on, 90
Else, 78
...
F_N.break, 80
F_N.continue, 80
File.absolute <svar>, <path_sexp>, 
File.copy <sourcePath_sexp>, <targetPath_sexp>{, <modes_sexp>}, 
File.delete <lvar>, <path_sexp>, 104
File.dir <path_sexp>, Array$[] {{{{,<dirmark_sexp>},<timeStamp_nexp>},  <recursive_nexp>}, <type_sexp>}, 
File.exists <lvar>, <path_sexp>, 
File.lastmodified <lvar>, <path_sexp>, 
File.mkdir <path_sexp>, 104
File.move <sourcePath_sexp>, <targetPath_sexp>{, <modes_sexp>}, 
...
Gr.bitmap.drawinto.end {<legacy_mode_nexp>}, 
Gr.bitmap.drawinto.start <bitmap_ptr_nexp>, 170
Gr.bitmap.fill <bitmap_ptr_nexp>, <x_nexp>, <y_nexp>, 170
GR.bitmap.filter <new_bitmap_ptr_nvar>, <bitmap_ptr_nexp>, <bundl_ptr_nexp>, 
Gr.bitmap.get <bundle_pointer_nexp>, <key_sexp>, <bitmap_ptr_nexp>, 
Gr.bitmap.get.histogram <bitmap_ptr_nexp>, alpha[], red[], green[], blue[], 
Gr.bitmap.get.pixarr <bitmap_ptr_nexp>, alpha[], red[], green[], blue[], 
Gr.bitmap.load <bitmap_ptr_nvar>, <file_name_sexp>{{{{{{{, <wB_nexp>}, <hB_nexp>}, <cropX_nexp>}, <cropY_nexp>}, <cropW_nexp>}, <cropH_nexp>}, <bgColor_sexp>}, 
...
Gr.bitmap.set.pixarr <bitmap_ptr_nvar>, alpha[]{, red[], green[], blue[]}, 
Gr.bitmap.size <bitmap_ptr_nexp>|<file_name_sexp>, width, height, 
...
Gr.clip <object__ptr_nexp>, <left_nexp>,<top_nexp>, <right_nexp>, <bottom_nexp>{, <RO_nexp>}, 
Gr.clipOut <object__ptr_nexp>, <left_nexp>,<top_nexp>, <right_nexp>, <bottom_nexp>
Gr.close, 155
Gr.cls, 155
Gr.color {{alpha}{, red}{, green}{, blue}{, style}{, paint}}, 152
Gr.drawable.delete <drawable_ptr_nexp>, 
Gr.drawable.draw <object_ptr_nvar>, <drawable_ptr_nexp>, left, top, right, bottom, 
Gr.drawable.get <bundle_pointer_nexp>, <key_sexp>, <drawable_ptr_nexp>, 
Gr.drawable.load <drawable_ptr_nvar>, <file_name_sexp>, 
Gr.drawable.put <bundle_pointer_nexp>, <key_sexp>, <drawable_pointer_nexp>, 
Gr.drawable.start <drawable_ptr_nvar>, 
Gr.drawable.stop <drawable_ptr_nvar>, 
Gr.front flag, 155
...
Gr.paint.set <bundle_nexp>{, <paint_nexp>}, 
Gr.path <obj_nvar>, <list_pointer_nvar> {, <x_nexp>, <y_nexp>}, 
Gr.point <obj_nvar>, x, y, 156
Gr.poly <obj_nvar>, list_pointer {{,x, y}, <close_nexp>}, 
...
Gr.screen width, height{{{{{, density }, isRound }, layout[]}, insets[]}, bounds[]}, 
Gr.screen.to_bitmap <bm_ptr_nvar>, 
Gr.set.antialias {{<lexp>}{,<paint_nexp>}}, 153
Gr.set.acceleration <mode_nvar>, 
Gr.set.cap {{<cap_nexp>}{,<paint_nexp>}}, 
...
Gr.show <object_number_nexp>{, <object_number_nexp> ...}, 
...
Html.paperformats <bundlePointer_nexp>, 
Html.post <url_sexp>, <list_nexp>, 114
Html.screenshot <filename_sexp>, 
Html.to.pdf <filename_sexp> {{{{, <paperformat_sexp>}, <orientation_sexp>}, <resolution_nexp>}, <color_sexp>}, 
...
JsonToXml$(<xml_sexp>{{,<spaces_nexp>}, <shrink_lexp>}), 
Kb.hide, 100
Kb.resume, 101
...
List.sort <pointer_nexp>{{{, <sort_mode_nexp>}, <locale_sexp>}, <strength_sexp>}, 
List.sort.by {<index_nexp>}, {<toSort_nexp>}, <by_nexp>{{{, <sort_mode_nexp>}, <locale_sexp>}, <strength_sexp>}, 
...
MAX(<nexp>, <nexp>), 57
MenuKey.resume, 88
MenuItem.get.datalink <data_svar>, 
MenuItem.resume, 
...
Notify <title_sexp>, <subtitle_sexp>, <alert_sexp>, <wait_lexp>{{, <options_bundle_nexp>}, <notification_id_nvar>}, 
Notify.cancel {<notification_id_nexp>}, 
Next, 79
OCT(<sexp>), 60
OCT$ (<nexp>), 69
OnBackground:, 139
...
Permission.automatic <auto_nvar>, 
Permission.checkPath <nvar>, <checkPath_sexp>, <dump_nexp>, 
Permission.get <granted_lvar>, <permission_sexp>, 
Permission.request <permission_sexp> | Array$[], 
Phone.call <sexp>, 125
Phone.dial <sexp>, 126
...
Read.from <nexp>, 90
Read.next <var>, ..., 89
REDIM {<preserve_nexp>}, Array[<nexp>{, <nexp> } ... ] ..., 
REDIM {<preserve_nexp>}, Array$[<nexp>{, <nexp> } ... ] ..., 
Rem, 51
Repeat, 80
...
Sql.set_locale <DB_pointer_nvar>, <locale_sexp>, 
...
XmlToJson$(<xml_sexp>{, <space_nexp>}), 
Zip.close, <file_table_nexp>, 116
Zip.count <path_sexp>, <nvar>, 116
Zip.dir <path_sexp>, Array$[] {,<timeStamp_nexp>}, 
Zip.extract <destination_path_sexp>, <zipFile_path_sexp>{{, <skip_overwrite_nexp>}, ToExtractArray$[]}, 
Zip.files FilesArray$[], EntriesArray$[], <zipFile_path_sexp>{{, <no_compr_sexp>}, <compr_type_sexp>}, 
Zip.open {r|w|a}, <file_table_nvar>, <path_sexp>, 116
Zip.read <file_table_nexp> ,<buffer_svar>, <file_name_sexp>, 116
Zip.write <file_table_nexp> ,<buffer_sexp>, <file_name_sexp>, 116
